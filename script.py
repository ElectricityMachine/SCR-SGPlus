...
def scan_for_dialog(type):
	...
	if type == "signal":
		...
		if flag:
			...
			if debug: print("IMAGE DETECTION: Dialog not found") # If you encounter this but the dialog is on the screen, please submit an issue on GitHub detailing the problem
			return False
	elif type == "station":
		if debug: print("None")
